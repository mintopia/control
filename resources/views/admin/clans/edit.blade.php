        ...
        <form action="{{ route('admin.clans.update', $clan->code) }}" method="post" class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name', $clan->name ?? '') }}">
                        <small class="form-hint">The name of the clan. The code is automatically generated from the name.</small>
                        @error('name')
