...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.events.tickettypes.delete', [$event->code, $type->id]) }}">Delete</a>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.tickettypes.destroy', [$event->code, $type->id]) }}" method="post" class="card">
