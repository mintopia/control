...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a
            href="{{ route('admin.events.mappings.delete', [$event->code, $mapping->id]) }}">Delete</a>
        @endsection
        ...
        @section('content')
            ...
            <div class="col-md-6 offset-md-3">
                <form action="{{ route('admin.events.mappings.destroy', [$event->code, $mapping->id]) }}" method="post"
                      class="card">
