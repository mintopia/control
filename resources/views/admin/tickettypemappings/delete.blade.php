...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.events.tickettypes.mappings.delete', [$event->code, $type->id, $mapping->id]) }}">Delete</a>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.tickettypes.mappings.destroy', [$event->code, $type->id, $mapping->id]) }}" method="post" class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="mt-4">
                    ...
                    <strong>{{ $mapping->name ?? $mapping->external_id }}</strong> to {{ $type->name }}?
                </p>
