...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a
            href="{{ route('admin.events.tickettypes.mappings.edit', [$event->code, $type->id, $mapping->id]) }}">Edit
            Mapping</a></li>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.tickettypes.mappings.update', [$event->code, $type->id, $mapping->id]) }}"
