...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.clans.members.destroy', [$clan->code, $member->id]) }}" method="post" class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="mt-4">
                    Are you sure you want to remove <strong>{{ $member->user->nickname }}</strong> from {{ $clan->name }}?
                </p>
            </div>
