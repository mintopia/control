...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.events.delete', $event->code) }}">Delete</a>
        @endsection
        ...
        @section('content')
            ...
            <div class="col-md-6 offset-md-3">
                <form action="{{ route('admin.events.destroy', $event->code) }}" method="post" class="card">
