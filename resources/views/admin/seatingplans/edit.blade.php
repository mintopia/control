...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a
            href="{{ route('admin.events.seatingplans.edit', [$event->code, $plan->id]) }}">Edit</a></li>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.seatingplans.update', [$event->code, $plan->id]) }}" method="post"
              class="card">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
