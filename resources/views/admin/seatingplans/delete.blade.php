...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.events.seatingplans.delete', [$event->code, $plan->id]) }}">Delete</a>
@endsection

@section('content')
    <div class="page-header mt-0">
        <h1>Delete {{ $plan->name }}</h1>
    </div>

    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.seatingplans.destroy', [$event->code, $plan->id]) }}" method="post" class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="mt-4">
                    Are you sure you want to delete <strong>{{ $plan->name }}</strong> for {{ $event->name }}?
                </p>
                <p>
