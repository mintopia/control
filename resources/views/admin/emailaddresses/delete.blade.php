...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.users.emails.delete', $email->user->id) }}">Delete Email Address</a>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.users.emails.destroy', [$email->user->id, $email->id]) }}" method="post" class="card">
