...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.events.seatingplans.seats.delete', [$event->code, $plan->id, $seat->id]) }}">Delete</a>
@endsection
...
@section('content')
    ...
    <div class="col-md-6 offset-md-3">
        <form action="{{ route('admin.events.seatingplans.seats.destroy', [$event->code, $plan->id, $seat->id]) }}" method="post" class="card">
