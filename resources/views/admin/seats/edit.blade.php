...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a
            href="{{ route('admin.events.seatingplans.seats.edit', [$event->code, $plan->id, $seat->id]) }}">Edit</a>
        @endsection
        ...
        @section('content')
            ...
            <div class="col-md-6 offset-md-3">
                <form
                    action="{{ route('admin.events.seatingplans.seats.update', [$event->code, $plan->id, $seat->id]) }}"
