...
/**
 * Placeholder unit test to avoid PHPUnit warnings.
 * The real tests were moved to Feature: tests/Feature/app/Services/TicketProviders/AbstractTicketProviderTest.php
 */
